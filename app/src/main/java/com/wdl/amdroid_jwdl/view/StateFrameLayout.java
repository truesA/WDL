...
public class StateFrameLayout extends FrameLayout {
    ...
    @IntDef({INIT, LOADING, EMPTY, NET_ERROR, SUCCESS, ERROR})
    ...
    private int mErrorRetryId =R.id.id_sfl_error_retry;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (ta != null) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                else if (index == R.styleable.StateFrameLayout_errorLayoutResId)
    ...
    public void setErrorViewLayoutId(@LayoutRes int layoutId) {
    ...
    protected void checkErrorView() {
        ...
        if (mErrorView != null) {
            View v = mErrorView.findViewById(mErrorRetryId);
            if (v != null)
     ...
     * 设置错误重试监听
     *
     * @param errorRetryId 触发监听的控件id
     * @param listener   重试监听
     */
    public void setOnErrorRetryListener(int errorRetryId, OnErrorRetryListener listener) {
        this.mNetErrorRetryId = errorRetryId;
        this.mErrorRetryListener = listener;
    }
