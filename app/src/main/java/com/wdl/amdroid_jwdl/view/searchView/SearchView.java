package com.wdl.amdroid_jwdl.view.searchView;
...
public class SearchView extends LinearLayout {
    ...
    private void init(){
        ...
        helper = new RecordSQLiteOpenHelper(contexts);
        ...
        searchBack.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // Toast.makeText(contexts, "返回到上一页", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void initView(){
        ...
        LayoutInflater.from(contexts).inflate(R.layout.search_layout,this);
        ...
        LinearLayout.LayoutParams localLayoutParams = (LinearLayout.LayoutParams)search_block.getLayoutParams();
        localLayoutParams.height = searchBlockHeight;
        search_block.setBackgroundColor(searchBlockColor);
        search_block.setLayoutParams(localLayoutParams);
    ...
    private void queryData(String tempName) {
        ...
        adapter = new SimpleCursorAdapter(contexts, android.R.layout.simple_list_item_1, cursor, new String[] { "name" },
