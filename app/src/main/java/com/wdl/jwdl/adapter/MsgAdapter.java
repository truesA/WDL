...
import com.wdl.jwdl.commom.CommonRecyclerViewAdapter;
import com.wdl.jwdl.commom.CommonViewHolder;
...
//        project_t1.setText(paramResultBean.getLevel());
        ...
        zcd_ll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                UserInfo userInfo =(UserInfo)PreferencesUtil.getInstance(App.getAppContext()).getObject("UserInfo");
                params.put("said",userInfo.getSaid());
                params.put("collection_user",paramResultBean.getUserid()+"");
