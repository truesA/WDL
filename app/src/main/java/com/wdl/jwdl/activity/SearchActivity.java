...
import com.wdl.jwdl.interfaces.MainBasePanService;
import com.wdl.jwdl.model.SeachBean;
import com.wdl.jwdl.util.UIUtils;
import com.wdl.jwdl.view.searchView.ICallBack;
import com.wdl.jwdl.view.searchView.SearchView;
import com.wdl.jwdl.view.searchView.bCallBack;
...
public class SearchActivity extends BaseActivity {
    ...
    private void getDataMsg(String String) {
        ...
        App.getRetrofit(API.BASE_URL)
                ...
                .getSeachContent(getSaId(),String)
    ...
    private void setData(SeachBean SeachBean) {
        ...
        userid = SeachBean.getResult().getUserid();
